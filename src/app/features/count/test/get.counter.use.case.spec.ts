...
import { getCountEndPoint } from '../data-source/default.count.data.source';
...
describe('Get Counter Feature', () => {
  ...
  it('should return a number entity with value of 5', () => {
    ...
    const req = httpTestingController.expectOne(getCountEndPoint);
    expect(req.request.url).toContain(getCountEndPoint);
